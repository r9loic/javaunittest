...
// feedback
#$string['auditlevel'] = 'Feedback';
#$string['AUDIT_VALUE_10'] = 'Audio Value at 10%';
#$string['AUDIT_VALUE_20'] = 'Audio Value at 20%';
#$string['AUDIT_VALUE_30'] = 'Audio Value at 30%';
#$string['AUDIT_VALUE_40'] = 'Audio Value at 40%';
#$string['AUDIT_VALUE_50'] = 'Audio Value at 50%';
#$string['AUDIT_VALUE_60'] = 'Audio Value at 60%';
#$string['AUDIT_VALUE_70'] = 'Audio Value at 70%';
#$string['AUDIT_VALUE_80'] = 'Audio Value at 80%';
#$string['AUDIT_VALUE_90'] = 'Audio Value at 90%';
...
$string['CA'] = 'BONNE REPONSER: Tout est bon.';
$string['PCA'] = 'PARTIELLEMENT CORRECT: Certaines réponses sont correctes, d\'autres non.';
$string['WA'] = 'FAUSSE REPONSE: Tout est faux.';
$string['CE'] = 'ERREUR DE COMPILATION: Votre code source ne compile pas. Vérifier et corriger les erreurs.';
...
$string['TO'] = 'TIMEOUT: Le temps d\'execution limite imparti est atteind.';
